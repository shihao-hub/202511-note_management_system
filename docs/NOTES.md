...
kafka:
1. https://lxblog.com/qianwen/share?shareId=5f13f213-bcc5-49ac-a50b-7de445ef6700
2. https://lxblog.com/qianwen/share?shareId=991a904c-84d8-42cd-b602-7d0a598fe648
...
# 魔塔社区的 ai 模型涉及的 gradio_client 库 pyintaller 打包不进来怎么解决？好像是 nicegui-pack 的问题...
# 而且 nicegui-pack 还不能添加 --hidden-import=gradio_client 这个参数...
# 看样子最好研究一下 PyStand（我之前开发贵州电网项目时已经触碰到了至少80%）
nicegui-pack --windowed --icon "icon.png" --name "笔记管理系统v1.1.4" main.py
```
